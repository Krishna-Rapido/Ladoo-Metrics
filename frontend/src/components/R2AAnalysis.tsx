...
export function R2AAnalysis() {
    ...
    const [data, setData] = useState<R2AResponse | null>(null);
        ...
        <div className="space-y-6">
            ...
            <div className="glass-card">
                <div className="card-header">
                    ...
                    <div>
                        <h3 className="card-title">R2A% Dashboard - Registration to Activation</h3>
                        <p className="card-subtitle">Configure parameters for R2A analysis</p>
                    </div>
                </div>
