...
export function DaprBucketAnalysis() {
    ...
    const [lowDapr, setLowDapr] = useState(0.6);
    const [highDapr, setHighDapr] = useState(0.8);

    const handleRunAnalysis = async () => {
        setLoading(true);
        setError(null);
        try {
            const res = await getDaprBucket({
                username,
            ...
            setError(e.message ?? 'Failed to fetch DAPR bucket data');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="glass-card">
                <div className="card-header">
                    ...
                    <div>
                        ...
                        <p className="card-subtitle">Configure parameters for DAPR bucket distribution analysis</p>
                    </div>
                </div>
                ...
                <div className="mt-6 grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            step="0.1"
                            value={lowDapr}
                            onChange={(e) => setLowDapr(parseFloat(e.target.value))}
                            className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                        />
                    </div>
                    <div>
                ...
                <div className="mt-6">
                    ...
                    >
                        {loading ? (
                            ...
                            <>
                                <span>▶</span>
                                <span>Run DAPR Bucket Analysis</span>
                            </>
                        )}
                    </button>
                </div>
                ...
                <div className="glass-card">
                    <div className="text-center py-16 text-slate-500">
                        ...
                        <p className="text-sm mt-2">
                            Configure parameters above and click "Run DAPR Bucket Analysis"
                        </p>
                    </div>
                </div>
            )}
